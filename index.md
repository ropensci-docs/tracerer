...
[![Peer Review
Status](https://badges.ropensci.org/209_status.svg)](https://github.com/ropensci/onboarding/issues/209)
...
| Branch | [![GitHub Actions logo](reference/figures/GitHubActions.png)](https://github.com/ropensci/tracerer/actions) | [![Codecov logo](reference/figures/Codecov.png)](https://www.codecov.io) |
|----|----|----|
...
`tracerer`, ‘Tracer for R’ is an R package to work with BEAST2 output
files.

![tracerer logo](reference/figures/tracerer_logo.png)

tracerer logo

`tracerer` is part of the
[`babette`](https://github.com/ropensci/babette) package suite:

- [`beautier`](https://github.com/ropensci/beautier) creates BEAST2
  input (`.xml`) files.
- [`beastier`](https://github.com/ropensci/beastier) runs BEAST2
- [`mauricer`](https://github.com/ropensci/mauricer): install BEAST2
  packages
- [`tracerer`](https://github.com/ropensci/tracerer) pastes BEAST2
  output (`.log`, `.trees`, etc) files.

Related R packages:

- [`lumier`](https://github.com/ropensci/lumier): Shiny app to help
  create the function call needed
- [`BEASTmasteR`](https://github.com/nmatzke/BEASTmasteR): tip-dating
  using fossils as dated terminal taxa
...
- [`tracerer_on_windows`](https://github.com/richelbilderbeek/tracerer_on_windows):
  verifies `tracerer` builds on Windows
...
See [FAQ](https://docs.ropensci.org/tracerer/faq.md)

## There is a feature I miss

See [CONTRIBUTING](https://docs.ropensci.org/tracerer/CONTRIBUTING.md),
